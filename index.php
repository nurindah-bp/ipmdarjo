              ...
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <ul class="nav">
                          ...
                          <li><a href="meetings.php">Berita</a></li>
      ...
      <div class="video-overlay header-text">
          <div class="container">
            <div class="row">
              <div class="col-lg-12">
                <div class="caption">
              <h2>PD IPM Sidoarjo</h2>
              <p>Web ini merupakan web resmi Pimpinan Daerah Ikatan Pelajar Muhammadiyah Sidoarjo (PD IPM Sidoarjo). Web ini berisi tentang IPM Sidoarjo berupa info IPM Sidoarjo, berita, opini, dan lain lain. </p>
              <div class="main-button-red">
                  <div class="scroll-to-section"><a href="#contact">Kontak Kami</a></div>
              </div>
          </div>
              </div>
            </div>
